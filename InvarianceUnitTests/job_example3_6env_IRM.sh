...
python scripts/sweep_outer.py --skip_confirmation True --new_hparam_interval True --n_envs 6 --models IRMv1 --datasets Example3 --scratch_dir "/scratch/ethancab/res_full_6env/example3_6env/IRM"