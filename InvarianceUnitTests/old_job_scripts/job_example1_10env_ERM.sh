...
python scripts/sweep_outer.py --skip_confirmation True --n_envs 10 --models ERM --datasets Example1 --scratch_dir "/scratch/ethancab/res_full_10env/example1_10env/ERM"