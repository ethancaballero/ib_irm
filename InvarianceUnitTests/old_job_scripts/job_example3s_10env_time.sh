...
python scripts/sweep_outer.py --skip_confirmation True --n_envs 10 --models IB_IRM --datasets Example3s --scratch_dir "/scratch/ethancab/res_time/example3s_10env/IB_IRM_time_it"