...
python scripts/sweep_outer.py --skip_confirmation True --n_envs 10 --models ERM --datasets Example2 --scratch_dir "/scratch/ethancab/res_full_10env/example2_10env/ERM"