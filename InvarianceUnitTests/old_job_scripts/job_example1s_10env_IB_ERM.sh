...
python scripts/sweep_outer.py --skip_confirmation True --n_envs 10 --models IB_ERM --datasets Example1s --scratch_dir "/scratch/ethancab/res_full_10env/example1s_10env/IB_ERM"