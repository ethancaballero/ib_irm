...
python scripts/sweep_outer.py --skip_confirmation True --n_envs 10 --models IB_IRM --datasets Example2s --scratch_dir "/scratch/ethancab/res_full_10env/example2s_10env/IB_IRM"