...
python scripts/sweep_outer.py --skip_confirmation True --n_envs 10 --models IRMv1 --datasets Example1s --scratch_dir "/scratch/ethancab/res_full_10env/example1s_10env/IRM"