...
#SBATCH --time=168:00:00                   # The job will run for 3 hours
...
python scripts/sweep_outer.py --skip_confirmation True --n_envs 10 --models IB_IRM IB_ERM IRMv1 ERM --datasets Example3s --scratch_dir "/scratch/ethancab/res_full/example3s_10env"