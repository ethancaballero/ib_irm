...
python scripts/sweep_outer.py --skip_confirmation True --n_envs 10 --models IB_ERM --datasets Example3 --scratch_dir "/scratch/ethancab/res_full_10env/example3_10env/IB_ERM"