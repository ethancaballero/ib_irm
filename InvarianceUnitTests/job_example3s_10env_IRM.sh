...
python scripts/sweep_outer.py --skip_confirmation True --n_envs 10 --models IRMv1 --datasets Example3s --scratch_dir "/scratch/ethancab/res_full_10env/example3s_10env/IRM"