...
#SBATCH --time=28:00:00                   # The job will run for 3 hours
...
python scripts/sweep_outer.py --skip_confirmation True --models IB_IRM IB_ERM --datasets Example1s --scratch_dir "/scratch/ethancab/res_full/example1s"