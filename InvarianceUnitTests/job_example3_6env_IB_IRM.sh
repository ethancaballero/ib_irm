...
python scripts/sweep_outer.py --skip_confirmation True --new_hparam_interval True --n_envs 6 --models IB_IRM --datasets Example3 --scratch_dir "/scratch/ethancab/res_full_6env/example3_6env/IB_IRM"